...
This ranges include all kind of space, specially ZERO WIDTH NON-JOINER and NARROW NO-BREAK SPACE that known as hald space and massively are using in Persian texts.
